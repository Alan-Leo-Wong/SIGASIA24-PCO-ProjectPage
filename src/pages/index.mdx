...
<Header
  ...
  links={[
    {
      name: "Paper (54.3Mb)",
      url: "https://media.githubusercontent.com/media/Alan-Leo-Wong/SIGASIA24-PCO-ProjectPage/refs/heads/main/src/assets/PCO___SigAsia_2024_self.pdf?download=true",
      icon: "fa-solid:file-pdf",
    },
    {
      name: "Paper - Low res (6.66Mb)",
      url: "https://media.githubusercontent.com/media/Alan-Leo-Wong/SIGASIA24-PCO-ProjectPage/refs/heads/main/src/assets/PCO___SigAsia_2024_low_res_self.pdf?download=true",
      icon: "fa-solid:file-pdf",
    },
    {
      name: "Supplementary Material (35.2Mb)",
      url: "https://media.githubusercontent.com/media/Alan-Leo-Wong/SIGASIA24-PCO-ProjectPage/refs/heads/main/src/assets/SIGA24_PCO_Supp_self.pdf",
      icon: "fa-solid:file-pdf",
    },
    {
      name: "Code",
